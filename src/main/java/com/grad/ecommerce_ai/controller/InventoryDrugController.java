...
public class InventoryDrugController {
    ...
    // Save InventoryDrug
    @PostMapping("/save")
    public ResponseEntity<ApiResponse<InventoryDrug>> saveInventoryDrug(@RequestBody InventoryDrug inventoryDrug, @RequestHeader String token) {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ApiResponse<InventoryDrug>> getInventoryDrugById(@PathVariable String id, @RequestHeader String token) {
    ...
    public ResponseEntity<ApiResponse<List<InventoryDrug>>> getAllDrugsForBranch(@PathVariable Long branchId, @RequestHeader String token) {
    ...
    public ResponseEntity<ApiResponse<InventoryDrug>> updateInventoryDrug(@PathVariable String id, @RequestBody InventoryDrug inventoryDrug, @RequestHeader String token) {
    ...
    public ResponseEntity<ApiResponse<Void>> deleteInventoryDrug(@PathVariable String id, @RequestHeader String token) {
