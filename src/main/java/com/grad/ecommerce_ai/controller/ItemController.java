...
public class ItemController {
    ...
    @PostMapping("/save")
    public ResponseEntity<ApiResponse<Item>> saveItem(@RequestBody @Valid Item item, @RequestHeader String token) {
    ...
    public ResponseEntity<ApiResponse<Item>> updateItem(@PathVariable Long id, @RequestBody @Valid Item item, @RequestHeader String token) {
